...
(function ($) {
    ...
    function vossenHeader() {
        ...
        // This function increases the nav bar height a bit when scroll position is at the top of the page and shrinks otherwise.
        function navSmall() {
        ...
        if ($('nav').data('animation') === 'hiding') {
            ...
            navSmall();
        } else if ($('nav').data('animation') === 'noShrink') {
        } else {
            navSmall();
        }
